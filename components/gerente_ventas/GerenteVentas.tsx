...
// export function GerenteVentasView() {
...
//           // Usamos el valor directamente ahora que sabemos que 'data' existe
...
import {
  ...
  ResponsiveContainer, // Renombrado para que no choque con el Tooltip de shadcn
  XAxis,
  YAxis,
} from "recharts";
                    ...
                    {displayMode === "monto" ? (
                      <>
                        ...
                        <span className="text-[10px] text-slate-400 font-medium whitespace-nowrap">
                          {/* Cambia item.quantity por item.cantidad si tu backend lo devuelve así */}
                          {Number(
