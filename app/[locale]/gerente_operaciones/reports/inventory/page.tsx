        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full xl:w-auto">
          ...
          <div className="w-full sm:w-56">
            <select
              ...
              disabled={!!userCids}
              className="w-full h-10 px-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all cursor-pointer shadow-sm disabled:opacity-70 disabled:cursor-default"
            >
              {!userCids && <option value="all">🏢 Ver Todas las Empresas</option>}
              {companies.map((c) => (
