...
import { listarPickingsPendientes } from "@/lib/seguridad/mercancia";
 ...
 * memoria el nombre exacto del picking (unica forma que habia hasta ahora,
 * via /api/seguridad/mercancia/odoo/[nombre]).
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const ordenes = await listarPickingsPendientes(cids);
