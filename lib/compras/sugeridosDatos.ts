 ...
 *
 * Vive aparte de la ruta porque lo usan dos: /api/compras/sugeridos y el
 * resumen de /api/compras/dashboard, que tienen que dar lo mismo. El calculo
 * en si esta en lib/compras/sugeridos.ts.
 *
