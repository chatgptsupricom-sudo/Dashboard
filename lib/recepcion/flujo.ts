...
// Los codigos de la pistola se comparten con la verificacion del egreso:
// viven en lib/escaneo/codigos y se re-exportan aca para no tocar a quien ya
// los importa de la recepcion.
export { esCodigoDeProducto, normalizarCodigo, productoPorPrefijo } from "@/lib/escaneo/codigos";
